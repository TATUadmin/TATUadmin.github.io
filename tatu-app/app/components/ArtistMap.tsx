...
const mockArtists: ArtistLocation[] = [
  { id: '1', name: 'Sarah Chen', specialty: 'Realism', rating: 4.9, lat: 40.7589, lng: -73.9851, avatar: '/api/placeholder/40/40' },
  { id: '2', name: 'Mike Rodriguez', specialty: 'Traditional', rating: 4.8, lat: 40.7505, lng: -73.9934, avatar: '/api/placeholder/40/40' },
  { id: '3', name: 'Emma Wilson', specialty: 'Watercolor', rating: 4.7, lat: 40.7614, lng: -73.9776, avatar: '/api/placeholder/40/40' },
  { id: '4', name: 'Alex Kim', specialty: 'Geometric', rating: 4.9, lat: 40.7282, lng: -73.7949, avatar: '/api/placeholder/40/40' },
  { id: '5', name: 'Jordan Taylor', specialty: 'Blackwork', rating: 4.6, lat: 40.6892, lng: -74.0445, avatar: '/api/placeholder/40/40' },
  { id: '6', name: 'Casey Martinez', specialty: 'Japanese', rating: 4.8, lat: 40.7831, lng: -73.9712, avatar: '/api/placeholder/40/40' },
  { id: '7', name: 'Riley Johnson', specialty: 'Minimalist', rating: 4.7, lat: 40.7505, lng: -73.9934, avatar: '/api/placeholder/40/40' },
  { id: '8', name: 'Taylor Swift', specialty: 'Portrait', rating: 4.9, lat: 40.7614, lng: -73.9776, avatar: '/api/placeholder/40/40' },
]

export default function ArtistMap() {
  const [userLocation, setUserLocation] = useState<{lat: number, lng: number} | null>(null)
  const [mapCenter, setMapCenter] = useState({ lat: 40.7589, lng: -73.9851 }) // NYC center
      ...
      {mockArtists.map((artist) => (
        ...
        >
          ...
          {selectedArtist?.id === artist.id && (
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-black/90 text-white p-2 rounded-lg text-xs whitespace-nowrap z-30">
              <div className="font-semibold">{artist.name}</div>
              <div className="text-gray-300">{artist.specialty}</div>
